                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="post" action="{{ route('events.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->
                            first('event_name', 'has-error') }}">
                            <label for="title" class="col-sm-2 control-label">
                                ชื่ออีเว้นท์
                                <span style="color: red; font-size: 15px;">* </span>
                            </label>
                            <div class="col-sm-5">
                                <input type="text" id="name" name="event_name" class="form-control" placeholder="ชื่ออีเว้นท์" value="{!! old('event_name') !!}" required>
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group {{ $errors->
                            ...
                            <div class="col-sm-5">
                                <input type="text" name="event_start_date" class="form-control datetimepicker-input" id="event_start_date" placeholder="DD/MM/YYYY" data-date-format="DD/MM/YYYY" autocomplete="off" value="{!! old('event_start_date') !!}" required>
                            </div>
                        ...
                        <div class="form-group {{ $errors->
                            ...
                            <div class="col-sm-5">
                                <input type="text" name="event_end_date" class="form-control datetimepicker-input" id="event_end_date" placeholder="DD/MM/YYYY" data-date-format="DD/MM/YYYY" autocomplete="off" value="{!! old('event_end_date') !!}" required>
                            </div>
                            <div class="col-sm-4">
