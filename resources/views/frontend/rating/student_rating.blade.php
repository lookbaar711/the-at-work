            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div id="inner">
                    <h6 style="text-align-last: center; padding-bottom: 10px;">
                        @lang('frontend/layouts/title.please_sent_student_rating_1')<br>
                        @lang('frontend/layouts/title.please_sent_student_rating_2')
                    </h6>
                </div>
                <br>
            </div>
    ...
    <div class="col-md-12">
        <div class="container">
            <div class="row"> 
                ...
                <div class="col-sm">
                    <a href="../sent_student_rating/{{$course_id}}" ><button type="submit" class="flex-c-m-rating size2 bo-rad-23 s-text3 bgwhite hov1 trans-0-5 col-12 sent-rating-student"><object class="colorz">@lang('frontend/layouts/title.sent_rating')</object></button></a>
                </div>
                <div class="col-sm"></div>
            </div>
        </div>
