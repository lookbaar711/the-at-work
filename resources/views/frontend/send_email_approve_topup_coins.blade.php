...
<div class="row">
    ...
    <div style="padding-bottom: 15px; font-size: 14px;">
        ...
        <label style="font-size: 16px;">คุณเติม Coins สำเร็จ</label><br><br>
        <label>คุณเติม Coins จำนวน {{ $coins }} Coins สำเร็จ</label><br>
        <label>จำนวน Coins ล่าสุดของคุณคือ {{ $sum_coins }} Coins</label><br>
        <label>เมื่อวันที่ {{ $topup_date }} เวลา {{ $topup_time }} น.</label><br><br>       
