...
<div class="row">
    ...
    <div style="padding-bottom: 15px; font-size: 14px;">
        ...
        <label style="font-size: 16px;">คุณเติม Coins ไม่สำเร็จ</label><br><br>
        <label>คุณเติม Coins จำนวน {{ $coins }} Coins ไม่สำเร็จ</label><br>
        <label>ข้อมูลการเติม Coins ของคุณไม่ถูกต้อง</label><br><br>       
