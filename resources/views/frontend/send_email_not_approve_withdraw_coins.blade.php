...
<div class="row">
    ...
    <div style="padding-bottom: 15px; font-size: 14px;">
        ...
        <label style="font-size: 16px;">คุณถอน Coins ไม่สำเร็จ</label><br><br>
        <label>คุณถอน Coins จำนวน {{ $coins }} Coins ไม่สำเร็จ</label><br>
        <label>ข้อมูลการถอน Coins ของคุณไม่ถูกต้อง</label><br><br>       
